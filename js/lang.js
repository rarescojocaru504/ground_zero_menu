const translations = {
    ro: {
        ...
        // Ground Zero Beers (Cu Imagini)
        name_easy_rider: "EASY RIDER", price_easy_rider: "15 RON", desc_easy_rider: "Bere cu o concentrație mai scăzută de alcool pentru a putea fi băută la o masă de prânz sau, în contextul în care vrei să bei mai multe, fară să te ia cu amețeală.", details_easy_rider: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 27 RON", img_easy_rider: "assets/bottles/easyrider.png",
        name_morning_glory: "MORNING GLORY", price_morning_glory: "16 RON", desc_morning_glory: "Exotică, cu note de mango, grapefruit și tușe de citrice. Puternic amară, evidențiind perfect caracterul hameiului.", details_morning_glory: "0.2L: 16 RON | 0.4L: 31 RON<br>1.5L: 109 RON | 0.33L: 29 RON", img_morning_glory: "assets/bottles/morningglory.png",
        name_split_pot: "SPLIT THE POT", price_split_pot: "17 RON", desc_split_pot: "O bere cu tărie crescută, hazy, miros de iarbă, bine aromată, cu mult hamei și note de fructe tropicale: ananas, mango, piersică.", details_split_pot: "0.2L: 17 RON | 0.4L: 33 RON<br>1.5L: 119 RON | 0.33L: 31 RON", img_split_pot: "assets/bottles/splittheepot.png",
        name_imperial_fuck: "IMPERIAL FUCK", price_imperial_fuck: "18 RON", desc_imperial_fuck: "O bere puternică, cu gust bogat, mai amară și mai aromată decât IPA, dar și cu o dulceaţă reținută. Una dintre cele mai puternice beri produse în România.", details_imperial_fuck: "0.2L: 18 RON | 0.4L: 35 RON<br>1.5L: 125 RON | 0.33L: 33 RON", img_imperial_fuck: "assets/bottles/imperialfuck.png",
        name_amber_guerre: "AMBER GUERRE", price_amber_guerre: "15 RON", desc_amber_guerre: "O bere roșie cu arome florale complexe și note de fructe negre, stafide, dar cu o amăreală fermă. Creată special pentru pairing-ul cu burger și carne la grătar.", details_amber_guerre: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 27 RON", img_amber_guerre: "assets/bottles/amberguerre.png",
        name_black_hole: "BLACK HOLE", price_black_hole: "15 RON", desc_black_hole: "Bere brună cu un corp mediu și concentrație mică de alcool. Gust ușor dulceag cu arome de malțuri prăjite, ciocolată neagră și tușe de cafea.", details_black_hole: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 32 RON", img_black_hole: "assets/bottles/blackhole.png",

        // Deranj Beers (Cu Imagini)
        name_deranj_blonda: "DERANJ BLONDĂ", price_deranj_blonda: "15 RON", desc_deranj_blonda: "Stil de bere tradițional nemțesc, fermentată și maturată natural până atinge gustul specific, lejer și răcoritor.", details_deranj_blonda: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 95 RON | 0.5L: 32 RON", img_deranj_blonda: "assets/bottles/deranjblonda.png",
        name_deranj_oranj: "DERANJ ORANJ", price_deranj_oranj: "15 RON", desc_deranj_oranj: "Bază de malt nemțesc din orz și grâu, peste care adăugăm hamei din Washington. Berea trece printr-un proces natural de fermentare și maturare la finalul căruia se adaugă extract de portocale 100% natural.", details_deranj_oranj: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 95 RON | 0.5L: 32 RON", img_deranj_oranj: "assets/bottles/deranjoranj.png",
        name_deranj_ipa: "DERANJ IPA", price_deranj_ipa: "16 RON", desc_deranj_ipa: "O bere de tip india Pale Ale brasată cu malțuri, hamei și drojdie de cea mai înaltă calitate, pentru un echilibru perfect.", details_deranj_ipa: "0.2L: 16 RON | 0.4L: 31 RON<br>1.5L: 107 RON | 0.5L: 35 RON", img_deranj_ipa: "assets/bottles/deranjipa.png",
        name_deranj_doar: "DOAR O BERE", price_deranj_doar: "15 RON", desc_deranj_doar: "O bere care oferă echilibrul perfect dintre malț și hamei și care, printr-o maturare îndelungată, capătă arome intense și o savoare rafinată.", details_deranj_doar: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.5L: 32 RON", img_deranj_doar: "assets/bottles/deranjdoarobere.png",

        // Special Beers
        name_x029: "XPERIMENTALE 029", price_x029: "22 RON", desc_x029: "Pentru a crea un profil de malt care să echilibreze dulceaţa și amărăciunea am adăugat boabe de cacao, cafea de specialitate, vanilie de Madagascar. Note de ciocolată, sherry și fructe negre.", details_x029: "0.2L: 22 RON | 0.4L: 43 RON",
        name_x030: "XPERIMENTALE 030", price_x030: "17 RON", desc_x030: "Pils german nefiltrat, cu malt din regiunea Bamber Germania, hamei Mandarina Bavaria - arome citrice, amăreală fină, gust super răcoritor.", details_x030: "0.2L: 17 RON | 0.4L: 33 RON<br>1.5L: 119 RON",
        ...
        // Guest & Extra
        name_tap1: "SCHNEIDER WEISSE TAP 1", price_tap1: "22 RON", desc_tap1: "Helle Weisse 4.9%", details_tap1: "0.5L",
        name_tap3: "SCHNEIDER WEISSE TAP 3", price_tap3: "25 RON", desc_tap3: "Alkoholfree <0.5%", details_tap3: "0.5L",
        name_tap5: "SCHNEIDER WEISSE TAP 5", price_tap5: "27 RON", desc_tap5: "Hopfenweisse 8.2%", details_tap5: "0.5L",
        name_sprit: "ȘPRIŢ CAII DE LA LETEA", price_sprit: "19 RON", desc_sprit: "Vin carbonatat", details_sprit: "0.2L: 19 RON | 0.4L: 37 RON",
        ...
        name_lemonaid_blood: "LEMONAID BLOOD ORANGE", price_lemonaid_blood: "23 RON", desc_lemonaid_blood: "", details_lemonaid_blood: "0.33L",
        name_lemonaid_passion: "LEMONAID PASSION FRUIT", price_lemonaid_passion: "23 RON", desc_lemonaid_passion: "", details_lemonaid_passion: "0.33L",
        name_lemonaid_ginger: "LEMONAID GINGER ECO", price_lemonaid_ginger: "23 RON", desc_lemonaid_ginger: "", details_lemonaid_ginger: "0.33L",
        name_apple: "SUC MERE SPRITZER", price_apple: "23 RON", desc_apple: "", details_apple: "0.33L",
        ...
        name_fritz: "FRITZ-KOLA", price_fritz: "19 RON", desc_fritz: "+/- Zahar", details_fritz: "0.33L",
    ...
    en: {
        ...
        name_easy_rider: "EASY RIDER", price_easy_rider: "15 RON", desc_easy_rider: "A less alcoholic beer to be consumed during lunch or when you want to drink more without getting dizzy.", details_easy_rider: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 27 RON", img_easy_rider: "assets/bottles/easyrider.png",
        name_morning_glory: "MORNING GLORY", price_morning_glory: "16 RON", desc_morning_glory: "Exotic, with notes of mango, grapefruit and hints of citrus. Strongly bitter, perfectly highlighting the hop character.", details_morning_glory: "0.2L: 16 RON | 0.4L: 31 RON<br>1.5L: 109 RON | 0.33L: 29 RON", img_morning_glory: "assets/bottles/morningglory.png",
        name_split_pot: "SPLIT THE POT", price_split_pot: "17 RON", desc_split_pot: "A stronger, hazy, grassy beer, well flavored, with lots of hops and tropical fruits hints (pineapple, mango, peach).", details_split_pot: "0.2L: 17 RON | 0.4L: 33 RON<br>1.5L: 119 RON | 0.33L: 31 RON", img_split_pot: "assets/bottles/splittheepot.png",
        name_imperial_fuck: "IMPERIAL FUCK", price_imperial_fuck: "18 RON", desc_imperial_fuck: "A strong rich taste beer, bitter and more flavored than an IPA, but also with a discreet sweetness. One of the strongest beers produced in Romania.", details_imperial_fuck: "0.2L: 18 RON | 0.4L: 35 RON<br>1.5L: 125 RON | 0.33L: 33 RON", img_imperial_fuck: "assets/bottles/imperialfuck.png",
        name_amber_guerre: "AMBER GUERRE", price_amber_guerre: "15 RON", desc_amber_guerre: "A red beer with a complex floral flavor and hints of black fruits, raisins, but with a sharp bitterness. Perfect for burger & grill pairing.", details_amber_guerre: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 27 RON", img_amber_guerre: "assets/bottles/amberguerre.png",
        name_black_hole: "BLACK HOLE", price_black_hole: "15 RON", desc_black_hole: "A soft body and low alcoholic concentration dark beer, slightly sweet with roasted malt, chocolate, coffee hints and a long tasty finish.", details_black_hole: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.33L: 32 RON", img_black_hole: "assets/bottles/blackhole.png",

        name_deranj_blonda: "DERANJ BLONDĂ", price_deranj_blonda: "15 RON", desc_deranj_blonda: "A traditional German beer style, naturally brewed until reaches its specific light and refreshing taste.", details_deranj_blonda: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 95 RON | 0.5L: 32 RON", img_deranj_blonda: "assets/bottles/deranjblonda.png",
        name_deranj_oranj: "DERANJ ORANJ", price_deranj_oranj: "15 RON", desc_deranj_oranj: "German malt from barley and wheat topped with a bit of hops and a drop of 100% natural orange extract.", details_deranj_oranj: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 95 RON | 0.5L: 32 RON", img_deranj_oranj: "assets/bottles/deranjoranj.png",
        name_deranj_ipa: "DERANJ IPA", price_deranj_ipa: "16 RON", desc_deranj_ipa: "Top quality malts, hops and yeast for a perfect balance.", details_deranj_ipa: "0.2L: 16 RON | 0.4L: 31 RON<br>1.5L: 107 RON | 0.5L: 35 RON", img_deranj_ipa: "assets/bottles/deranjipa.png",
        name_deranj_doar: "DOAR O BERE", price_deranj_doar: "15 RON", desc_deranj_doar: "A beer that offers the perfect balance between malt and hops and, through long maturation, develops intense aromas and a refined flavor.", details_deranj_doar: "0.2L: 15 RON | 0.4L: 29 RON<br>1.5L: 99 RON | 0.5L: 32 RON", img_deranj_doar: "assets/bottles/deranjdoarobere.png",

        name_x029: "XPERIMENTALE 029", price_x029: "22 RON", desc_x029: "To create a malt profile that balances both the sweetness and bitterness of this classic style, we added cocoa beans, specialty coffee, and Madagascar vanilla. Notes of chocolate, sherry, cocoa beans, and dark fruits.", details_x029: "0.2L: 22 RON | 0.4L: 43 RON",
        name_x030: "XPERIMENTALE 030", price_x030: "17 RON", desc_x030: "Unfiltered German Pilsner made with malt from the Bamberg region of Germany and Mandarina Bavaria hops-featuring citrus aromas, a refined bitterness, and a super-refreshing taste.", details_x030: "0.2L: 17 RON | 0.4L: 33 RON<br>1.5L: 119 RON",
        ...
        name_tap3: "SCHNEIDER WEISSE TAP 3", price_tap3: "25 RON", desc_tap3: "Alkoholfree <0.5%", details_tap3: "0.5L",
        name_tap5: "SCHNEIDER WEISSE TAP 5", price_tap5: "27 RON", desc_tap5: "Hopfenweisse 8.2%", details_tap5: "0.5L",
        name_sprit: "HOMEMADE CARBONATED WINE", price_sprit: "19 RON", desc_sprit: "", details_sprit: "0.2L: 19 RON | 0.4L: 37 RON",
        ...
        name_fritz: "FRITZ-KOLA", price_fritz: "19 RON", desc_fritz: "With or without sugar", details_fritz: "0.33L",
