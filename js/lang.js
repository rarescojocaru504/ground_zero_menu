/*
 * Ground Zero QR menu – translations (RO / EN)
 *
 * Every element in index.html with data-i18n="key" gets its innerHTML from here
 * when the language changes; data-i18n-href="key" swaps a link's href.
 * - Both languages MUST have the same keys (a missing key keeps the previous text).
 * - Values are HTML: <br> = new line, <i> = allergens line,
 *   <b> = "Savurează cu:" / "Pair with:" label, <strong> = beer name.
 * - Prices, volumes and weights are not here – they live in index.html.
 */
const translations = {
    ro: {
        // --- Tabs & section titles ---
        ...
        // --- Special beers: XperimentALE + beer flight ---
        ...
        // --- Guest beers & extra: names that differ between RO and EN ---
        ...
        // --- Food: name + description, allergens (<i>), pairing (<b> label, <strong> beer names) ---
        name_carnat: "CÂRNAT ÎMPUȘCAT", desc_carnat: "Cârnat kasekrainer de porc cu brânză, muștar, castravete murat, pâine.<br><i>Alergeni: gluten, muștar, lactate</i><br><b>Savurează cu:</b> Helles, Kolsch - <strong>Deranj Blonda</strong>, <strong>Deranj Doar O Bere</strong>",
        ...
        name_chiftea_vara: "CHIFTEA DE VARĂ", desc_chiftea_vara: "Smash Burger de vită x2, cheddar x2, castravete murat, ceapă roșie, mustar, ketchup, chiflă cu unt.<br><i>Alergeni: lactate, ou, gluten, muștar</i><br><b>Savurează cu:</b> IPA - <strong>Split The Pot</strong>, <strong>Imperial fuck</strong>",
        ...
        name_curry: "CURRYWURST", desc_curry: "Kasekrainer de porc, cartofi prăjiti, ketchup, ceapă prăjită, curry.<br><i>Alergeni: țelină, lactoză</i><br><b>Savurează cu:</b> IPA - <strong>Morning Glory</strong>",
        ...
        // Legend under the food menu (* = frozen product)
        ...
        // --- Flyer buttons (text + PDF link) and floating service banner ---
    ...
    en: {
        ...
        // --- Food: name + description, allergens (<i>), pairing (<b> label, <strong> beer names) ---
        name_carnat: "KASEKRAINER SAUSAGE", desc_carnat: "Pork Kasekrainer with cheese, mustard, pickles, bread.<br><i>Allergens: dairy, gluten, mustard</i><br><b>Pair with:</b> Helles, Kolsch - <strong>Deranj Blonda</strong>, <strong>Deranj Doar O Bere</strong>",
        ...
        name_chiftea_vara: "FRESH SMASH", desc_chiftea_vara: "Beef patty, cheddar, bacon, iceberg salad, tartar sauce (mayonnaise sauce, pickles, onions, mustard, paprika), soft butter bun.<br><i>Allergens: dairy, egg, gluten, mustard</i><br><b>Pair with:</b> IPA - <strong>Split The Pot</strong>, <strong>Imperial fuck</strong>",
